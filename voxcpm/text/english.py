...
import re
from .lib.en import wordsegment
from .lib.en.g2p_en import G2p
...
from .lib.en.en_normalization.expend import normalize

from .lib.ja.tokenizer import esupar

from .lib.en.g2p_en.load_cmu import get_dict

nlp=esupar.load(model="en_large", )



EN_DICT_DIR = Path(__file__).parent / "lib/en/en_dict"
