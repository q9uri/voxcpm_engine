...
from kabosu_core.language.njd.ja.lib.asapy.parse.semantic.calculate import Calculate
from kabosu_core.language.njd.ja.lib.asapy.parse.semantic.adjunct import Adjunct
from kabosu_core.language.njd.ja.lib.asapy.parse.semantic.noun_structure import NounStructure
