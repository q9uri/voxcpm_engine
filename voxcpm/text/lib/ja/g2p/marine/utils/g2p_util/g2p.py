...
from kabosu_core.language.njd.ja.lib.marine.types import AccentRepresentMode

from kabosu_core.language.njd.ja.lib.marine.utils.g2p_util.accent import (
...
from kabosu_core.language.njd.ja.lib.marine.utils.g2p_util.boundary import represent_syllable_boundary
from kabosu_core.language.njd.ja.lib.marine.utils.g2p_util.util import (
    CONNECTABLE_MORA,
    HALF_PUNCTUATION,
    LONGVOWEL_CHARACTER,
    NON_MORA_LIST,
