...
from kabosu_core.language.njd.ja.lib.marine.utils.g2p_util import mora2phon, pron2mora
from kabosu_core.language.njd.ja.lib.marine.utils.regex import has_longvowel


if TYPE_CHECKING:
    from kabosu_core.language.njd.ja.lib.marine.utils.metrics import MultiTaskMetrics
