...
from kabosu_core.language.njd.ja.lib.marine.data.dictionary_downloader import download_and_apply_dictionaries
from kabosu_core.language.njd.ja.lib.marine.logger import getLogger
from kabosu_core.language.njd.ja.lib.marine.utils.openjtalk_util import convert_open_jtalk_node_to_feature
from kabosu_core.language.njd.ja.lib.marine.utils.util import load_json_corpus
